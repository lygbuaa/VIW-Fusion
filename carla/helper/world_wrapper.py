...
class CameraManager(object):
    def __init__(self, parent_actor, hud, gamma_correction):
        ...
        if not self._parent.type_id.startswith("walker.pedestrian"):
            self._camera_transforms = [
                (carla.Transform(carla.Location(x=0.0, y=-5.0, z=bound_z/2.0), carla.Rotation(yaw=90.0)), Attachment.Rigid),
    ...
    def toggle_camera(self):
        ...
        g_logger.info("toggle view[%d]: %s", self.transform_index, self._camera_transforms[self.transform_index][0])
