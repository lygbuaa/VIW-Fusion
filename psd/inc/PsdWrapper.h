...
public:
    ...
    bool run_model(cv::Mat& img, Detections_t& det, bool debug_save=false, const std::string& path="./ipm_psd.png"){
        HANG_STOPWATCH();
    ...
    void draw_parklots(cv::Mat& img, Detections_t& det, const std::string& save_path){
        char tmp[32] = {0};
